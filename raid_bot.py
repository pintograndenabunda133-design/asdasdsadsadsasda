...
async def on_message(message):
    ...
    # ---- !shop (SÓ OWNER) — Cria servidor de vendas completo ----
        ...
        if sub_cmd == "setup":
            ...
            # chat-geral: pode mandar mensagem, NÃO pode enviar mídia, NÃO pode usar comandos
            ...
            chat_geral.overwrite_permissions(role_staff, attach_files=True)

            # midias: pode enviar mídia, pode mandar mensagem, NÃO pode usar comandos
            ...
            # comandos: pode mandar mensagem, NÃO pode enviar mídia, pode usar comandos
